...
const parser = require("./peg/grammar.js");
const fetchRegulationData = require("./fetchRegulationData.js");
const { matchVarToKeywords, countOccurrence } = require("./helperFunction.js");
...
function activate(context) {
  ...
  console.log(
    'Congratulations, your extension "code-annotator" is now active!'
  );
    ...
    async function () {
      ...
      if (editor) {
        ...
        try {
          ...
          //         console.log("hover", document, position, range);
          //         console.log("var", variable);

          //         // Create a Markdown string for the hover content
          //         const hoverContent = new vscode.MarkdownString();
          //         hoverContent.appendCodeblock(variable, "python");
          //         hoverContent.appendMarkdown(
          //           "This is some additional information about the word."
          //         );
  ...
  const commandRegistration = vscode.commands.registerTextEditorCommand(
    "code-annotator.printReferences",
    async (editor) => {
      // Get regulation data
      const techType = await vscode.window.showQuickPick([
        "Credit-Scoring",
